...
var ModelSchema = function (modelName, schema, connection, options) {
    ...
    Model.prototype.save = function (saveOptions, callback) {
    ...
    Model.prototype.remove = function (removeOptions, callback) {
    ...
    Model.prototype.markModified = function (field) {
    ...
    Model.remove = function (args, removeOptions, callback) {
        ...
        if (argumentString.indexOf('WHERE') === -1) {
          throw new Error('Cannot delete entire table, must have row selector');
        }
